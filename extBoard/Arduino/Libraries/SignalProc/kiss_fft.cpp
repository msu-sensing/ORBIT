...
void kiss_fftr(kiss_fftr_cfg st,kiss_fft_scalar *timedata,kiss_fft_cpx *freqdata)
{
    ...
    kf_work(st->tmpbuf, (kiss_fft_cpx*)timedata, 1, 1, st->substate->factors, st->substate);
